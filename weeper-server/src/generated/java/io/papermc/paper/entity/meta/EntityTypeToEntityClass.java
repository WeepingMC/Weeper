...
public final class EntityTypeToEntityClass {
    ...
    private static final Map<EntityType, Class<? extends Entity>> initialize() {
        ...
        result.put(EntityType.CUSHION, Cushion.class);
        ...
        result.put(EntityType.POPLAR_BOAT, Boat.class);
        result.put(EntityType.POPLAR_CHEST_BOAT, ChestBoat.class);
        ...
        result.put(EntityType.SULFUR_CUBE, SulfurCube.class);
