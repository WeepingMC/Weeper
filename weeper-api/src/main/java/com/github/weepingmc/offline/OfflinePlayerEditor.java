...
public interface OfflinePlayerEditor {
     ...
     * @param editPlayerConsumer A consumer function that takes an {@link com.github.weepingmc.offline.EditPlayer} object as input, allowing the caller to perform edits on the player's information.
     */
